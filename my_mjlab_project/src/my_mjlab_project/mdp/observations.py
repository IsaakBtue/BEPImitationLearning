"""Goalkeeper-specific observation terms."""
...
def ball_pos_b(env: ManagerBasedRlEnv, ball_name: str = "ball") -> torch.Tensor:
    """Ball position in robot base (pelvis) frame. Shape (N, 3)."""
...
def left_hand_pos_b(
    ...
    """Left wrist position in robot base frame. Shape (N, 3)."""
...
def right_hand_pos_b(
    ...
    """Right wrist position in robot base frame. Shape (N, 3)."""
    robot: Entity = env.scene[asset_cfg.name]
