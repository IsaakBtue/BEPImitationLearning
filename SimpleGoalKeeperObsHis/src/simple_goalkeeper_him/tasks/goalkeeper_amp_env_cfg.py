...
from simple_goalkeeper_him.mdp import MultiMotionCommandCfg
import simple_goalkeeper_him.mdp.observations as gk_obs
import simple_goalkeeper_him.mdp.rewards as gk_rew
import simple_goalkeeper_him.mdp.resets as gk_resets
from simple_goalkeeper_him.mdp.resets import adaptive_curriculum_update, task_reward_curriculum
from simple_goalkeeper_him.robots.t1_constants import get_t1_robot_cfg, T1_ACTION_SCALE
...
def goalkeeper_amp_play_env_cfg(num_steps_per_env: int = 100) -> ManagerBasedRlEnvCfg:
    ...
    from simple_goalkeeper_him.tasks.goalkeeper_env_cfg import get_axes_spec
