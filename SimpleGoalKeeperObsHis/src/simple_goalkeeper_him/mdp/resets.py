...
def reset_ball_per_motion(
    ...
    """
    from simple_goalkeeper_him.mdp.commands import _BALL_END_RANGES, _BALL_END_RANGES_EASY
...
def reset_robot_rsi(
    ...
    # 50% RSI (random motion frames), 50% standing pose
    use_rsi = np.random.random(n) < 0.5
