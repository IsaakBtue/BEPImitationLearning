"""Diagnostic metrics for the blue-ball landing gate (ported from SimpleGoalKeeper).
...
by episode length"). Distinguishes a landing the policy caused from one an
RSI reset pose handed it for free, since a foot that starts an episode already
lifted near the blue midpoint can satisfy the landing gate without the policy
doing anything.
"""
